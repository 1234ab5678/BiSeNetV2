...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    count           = True
    #name_classes    = ["background", "cell", "line","nonline"]
    ...
    if mode == "predict":
        ...
        for filename in os.listdir("./img/"):
            ...
            #image = Image.open("./miou_pr_dir" + "/" + filename.split('.')[0] + ".png")
            #image = np.array(image)
            #image = Image.fromarray(np.uint8(image))
            #image.save("./miou_pr_dir" + "/" + filename.split('.')[0] + ".png")
